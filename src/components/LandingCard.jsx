    ...
    <div className="flex flex-col justify-between md:grid md:grid-cols-2 px-5 lg:flex  items-start mb-8 gap-4 lg:flex-row lg:flex-wrap ">
      {landingCards.map((card) => {
        return (
          <div
            key={card.id}
            className="px-4 py-4 lg:ml-0 shadow-2xl md:h-[800px] bg-base-100 lg:h-[800px] rounded-md mb-4 border-base-content flex flex-col  border border-spacing-4 place-items-start justify-start gap-4 w-80 md:w-80 md:ml-8 lg:w-[30vw] "
          >
            <img
              src={card.image}
              alt="image"
