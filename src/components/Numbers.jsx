...
const Numbers = () => {
  return (
    <div className="mt-4 flex flex-col justify-center items-center">
      ...
      <div className=" w-full flex flex-col justify-center  md:justify-evenly px-5 text-primary text-lg md:text-xl lg:text-2xl items-center md:flex-row md:flex-wrap ">
        {numbers.map((number) => {
          return (
            <div
              key={number.id}
